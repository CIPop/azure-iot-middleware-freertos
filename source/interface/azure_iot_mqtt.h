 ...
 *
 * @brief Definition for the Azure IoT MQTT.
 *
 */
 ...
 *
 * @param[in] xContext The context to initialize.
 ...
 *      - eAzureIoTMQTTBadParameter if invalid parameters are passed.
 *      - eAzureIoTMQTTSuccess otherwise.
 */
 ...
 * @param[in] pxWillInfo Last Will and Testament. Pass NULL if Last Will and
 * Testament is not used.
 * @param[in] ulTimeoutMs Maximum time in milliseconds to wait for a CONNACK packet.
 ...
 *
 * @param[in] xContext Initialized MQTT context.
 * @param[in] pxSubscriptionList List of MQTT subscription info.
 * @param[in] xSubscriptionCount The number of elements in pSubscriptionList.
 ...
 *
 * @param[in] xContext Initialized and connected MQTT context.
 *
 * @return An #AzureIoTMQTTResult_t with the result of the operation.
 */
 ...
 *
 * @param[in] xContext Initialized and connected MQTT context.
 * @param[in] ulTimeoutMs Minimum time in milliseconds that the receive loop will
 ...
 * @return An #AzureIoTMQTTResult_t with the result of the operation.
 */
AzureIoTMQTTResult_t AzureIoTMQTT_ReceiveLoop( AzureIoTMQTTHandle_t xContext,
                                               uint32_t ulTimeoutMs );
